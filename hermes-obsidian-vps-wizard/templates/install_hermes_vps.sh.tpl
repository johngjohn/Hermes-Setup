...
CONFIG_PATH_RAW="${HERMES_CONFIG_PATH}"
ENV_PATH_RAW="${HERMES_ENV_PATH}"
...
6. Export OBSIDIAN_API_KEY and run ./verify_vps_mcp.sh ${VPS_REMOTE_PORT} once the tunnel is active.
MSG

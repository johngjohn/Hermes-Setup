param(
    ...
    [string]$LogFile = "%USERPROFILE%\hermes-obsidian-reverse-ssh.log",
    [string]$VpsHost = "vps.example.net",
    [int]$VpsSshPort = 22,
    [string]$VpsUser = "hermes",
    [int]$VpsRemotePort = 37124,
    [int]$ObsidianLocalPort = 27124,
    [int]$RetrySeconds = 5
)
